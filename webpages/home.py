...
def app():
    ...
    st.image(r"https://media0.giphy.com/media/aOOdD40c3t9J85HJzZ/source.gif", width = 300)

    st.write('**What are you waiting for?**')
    st.write('**Create your account and start using AutoMentor!**')
    st.image(r"https://sp-ao.shortpixel.ai/client/to_webp,q_glossy,ret_img,w_1150/https://www.st-agnes.manchester.sch.uk/wp-content/uploads/2018/11/car-gif-png-1.gif", width = 300)
