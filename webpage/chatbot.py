...
def check_password():
    ...
    def password_entered():
        ...
        user_data = load_user_data("./chatbot_util/customer_data.csv")  # because we use st.stop, even if this was run outside of check_password, this would always be re-executed if password was incorrect, so I left it here for easier reading
